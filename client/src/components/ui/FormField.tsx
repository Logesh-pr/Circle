  ...
  return (
    <div className="flex flex-col gap-y-2 mb-2 relative">
      ...
      <input
        ...
        className={`form-input bg-white dark:bg-black w-full border placeholder:text-sm placeholder:text-light-primary ${error ? "border-red-500" : "border-light-border dark:border-dark-border focus:border-dark-secondary "} ${disabled && "opacity-50 cursor-not-allowed"}`}
      />
